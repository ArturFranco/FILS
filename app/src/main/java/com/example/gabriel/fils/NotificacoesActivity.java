                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if(entry.descricao.startsWith("Solicitacao")){
                            ...
                            if(perfil == 1) {
                                ...
                                dialog.setContentView(R.layout.dialog_notificacao_meta_prof);
                            }

                            TextView titulo = (TextView) dialog.findViewById(R.id.tituloDialogAddAluno);
                            titulo.setText("Meta Alcançada");
